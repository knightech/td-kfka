...
@WebMvcTest(TitleDiscoveryController.class)
public class TitleDiscoveryControllerTest {
...
private ObjectMapper objectMapper = new ObjectMapper();
    ...
    public void getItemsByGenreList() throws Exception {
        ...
        verify(titleDiscoveryService).getItemByGenre(anyString());

        verifyNoMoreInteractions(titleDiscoveryService);
